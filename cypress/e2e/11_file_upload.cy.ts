describe("Handling file upload", () => {
  it("File uploads", () => {
    ...
    cy.get(
      ".qq-file-id-0.qq-upload-success").should("be.visible")
  });
  ...
  it("File upload - rename", () => {
    ...
    // verify whether the file is uploaded or not
    cy.get(
      "span[title='TestFile.jpg']"
    ).should("have.text", "TestFile.jpg");
  });
  ...
  it("Multiple file upload", () => {
    ...
    const expectedText = index === 0 ? '1200px-Sunflower_from_Silesia2.jpg' : 'snickers.jpg';
